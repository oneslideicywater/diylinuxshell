  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M933.8 348.4h-64v-96.7c0-29.4-23.9-53.3-53.3-53.3H373.9v-64h442.6c64.7 0 117.3 52.6 117.3 117.3v96.7z"
            fill="currentColor"
          />
          <path
            d="M330.6 162.7l63.9 159.7c6.4 15.9 17.2 29.4 31.4 39C440 371 456.5 376 473.7 376h406.6c11.8 0 21.3 9.6 21.3 21.3V840c0 11.8-9.6 21.3-21.3 21.3H142.6c-11.8 0-21.3-9.6-21.3-21.3V184c0-11.8 9.6-21.3 21.3-21.3h188m28.9-64H142.6c-47.1 0-85.3 38.2-85.3 85.3v656c0 47.1 38.2 85.3 85.3 85.3h737.7c47.1 0 85.3-38.2 85.3-85.3V397.4c0-47.1-38.2-85.3-85.3-85.3H473.7c-8.7 0-16.6-5.3-19.8-13.4l-74.6-186.5c-3.3-8.2-11.1-13.5-19.8-13.5z"
            fill="currentColor"
          />
          <path
            d="M630.9 649.5H346.5c-17.7 0-32-14.3-32-32s14.3-32 32-32h284.4c17.7 0 32 14.3 32 32s-14.3-32 32-32z"
            fill="currentColor"
          />
          <path
            d="M548 751.6c-8.2 0-16.4-3.1-22.6-9.4-12.5-12.5-12.5-32.8 0-45.3l82.4-82.4-82.4-82.4c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l105 105c12.5 12.5 12.5 32.8 0 45.3l-105 105c-6.3 6.4-14.5 9.5-22.7 9.5z"
            fill="currentColor"
          />
        </svg>
      </button>
